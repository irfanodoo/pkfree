...
class WeeklyCustomerPortal(portal.CustomerPortal):
    ...
    def portal_weekly_form_view(self, page=1, **kw):
        ...
        return request.render("pk_employee_portal.weekly_schedule_form_view_temp_id", values)
    ...
    def portal_weekly_list_view(self, leave_id, **kw):
        ...
        return request.render("pk_employee_portal.weekly_schedule_form_view_temp_id", vals)
